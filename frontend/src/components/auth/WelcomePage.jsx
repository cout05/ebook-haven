...
const WelcomePage = () => {
  return (
    <div className="md:h-screen bg-my-background-image text-[#EFECEC] bg-[#39ad91] flex gap-4 justify-between md:justify-start items-center md:items-baseline md:flex-col w-screen md:w-[50%] px-4 py-2">
